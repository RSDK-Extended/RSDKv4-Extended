...
void PlayVideoFile(char *filePath)
{
    ...
    if (file) {
        ...
        //TODO: There has to be a better way to check for more than a single audio stream.
        //Especially for stuff beyond Sonic CD
#if RETRO_USING_SDL2 && !RETRO_USING_OPENGL
        videoDecoder = THEORAPLAY_startDecode(&callbacks, /*FPS*/ 30, THEORAPLAY_VIDFMT_IYUV,
                                              Engine.gameType == GAME_SONICCD ? GetGlobalVariableByName("Options.Soundtrack") ? 1 : 0 : 0);
#endif
